      ...
      <AnimatePresence>
        {isFloatingWindowOpen && (
            <motion.div
                ...
                className="fixed z-40 bg-white dark:bg-slate-900 border dark:border-slate-700 shadow-2xl rounded-xl overflow-hidden flex flex-col"
                style={{ 
                    left: windowPos.x, 
                    top: windowPos.y,
            ...
            >
                {/* Header */}
                <div 
                    className="p-3 bg-slate-50 dark:bg-slate-800 border-b dark:border-slate-700 flex items-center justify-between cursor-move select-none shrink-0"
                ...
                {/* Resize Handle */}
                <div 
                    className="absolute bottom-0 right-0 w-6 h-6 cursor-nwse-resize z-50 flex items-end justify-end p-1 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-tl transition-colors"
